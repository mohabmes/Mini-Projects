...
public class EditItemActivity extends AppCompatActivity implements Observer {
    ...
    public void saveItem(View view) {
        ...
        if (!validateInput(title_str, maker_str, description_str, dimensions)) {
            return;
        }
    ...
    public boolean validateInput(String title_str, String maker_str, String description_str, Dimensions dimensions) {
        if (title_str.equals("")) {
        ...
        if (dimensions.getLength().equals("")) {
            length.setError("Empty field!");
            return false;
        }

        if (dimensions.getWidth().equals("")) {
            width.setError("Empty field!");
            return false;
        }

        if (dimensions.getHeight().equals("")) {
